...
export const openSuperBlockEditor = (nodeElement: HTMLElement) => {
    ...
    <div id="sbCodeHint" class="ft__smaller ft__on-surface" style="margin-bottom: 8px">Code runs with <code class="fn__code">ctx</code> in scope. <b>Tip:</b> write to <code class="fn__code">ctx.el</code> — or just <code class="fn__code">return</code> a string/element — to show content in the block.</div>
