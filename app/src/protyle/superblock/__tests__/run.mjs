...
const MODULES = ["builtinFeatures", "builtinProperties", "viewEngine", "reminderEngine", "reminderScheduler", "icsExport", "nlDate", "featureFlags", "cron", "hotkey", "storage", "blockDecorators", "uiSurfaces", "exportRegistry"];
